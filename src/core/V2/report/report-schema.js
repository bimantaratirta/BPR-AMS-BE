...
export const reportSchema = {
  ...
  create: Joi.object({
    ...
    // status & process
    status: Joi.string().valid('GOOD', 'NO_GOOD', 'DRAFT').required().messages({
      'any.only': 'status must be one of: GOOD, NO_GOOD, DRAFT',
    ...
    process: Joi.string()
      ...
      .messages({
        'any.only':
          'process must be one of: SEND_SLO, REVIEW_SLO, DECLINE_SLO, SEND_AM, REVIEW_AM, ACCEPTED_AM, DECLINE_AM',
      }),

...
class KSMController {
  async get(req, res) {
    ...
    const datas = await KSMService.getAll(page, limit);
  ...
  async generatePDF(req, res) {
    try {
      ...
      const data = {
        ...
        provisi: dbData.provisi_persen,
        administrasi: dbData.administrasi_persen,
        ...
        mendapat_persetujuan_dari: dbData.hubungan_penjamin_debitur,
